public class Book {
    ...
    public static void main(String[] args){
        Book (String aTitle, String anAuthor, int anISBN, double aPrice, String aCondition)
        Book("Sea of Poppies", "Ghosh", 9780312428594, 18,"new");
        ...
        Book("Linear Algebra and it's Applications" , "Lay" , 9780321982384, 214,"new", "5");
        Book("Black Flags", "Warrick",9780804168939 , 16,"new");
        Book("Violent Borders", "Jones", 9781784784713, 27.95,"new");
        Book("Globalization Paradox", "Rodrik", 9780393341287, 18.9,"new");
        Book("Microeconomics with Calculus" , "Nechyba",9781305650466, 381.25,"new");
